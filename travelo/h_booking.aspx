<%@ Page Title="" Language="C#" MasterPageFile="~/travelo/beforeindex.Master" AutoEventWireup="true" CodeBehind="h_booking.aspx.cs" Inherits="Bon_Voyage.travelo.h_booking" %>
                        ...
                        <form action="#">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="single_input">
                                      <%--  <input type="text" placeholder="Your Name">--%>
                                                  <asp:TextBox ID="check_in" placeholder="DD/MM/YYYY" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="single_input">
                                      <%--  <input type="text" placeholder="Your Name">--%>
                                                  <asp:TextBox ID="check_out" placeholder="DD/MM/YYYY" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="submit_btn">
                                        <%--<button class="boxed-btn4"   type="submit">submit</button>--%>
                                            <asp:Button ID="Button1" runat="server" class="boxed-btn4" Text="Confirm" />
                                    </div>
                                </div>
                            </div>
                        </form>
